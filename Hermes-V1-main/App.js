...
export default function App() {
  ...
  return (
    <NavigationContainer theme={theme}>
      ...
      >
        {user ? (
          <Stack.Screen name="HermesTravel" component={MainTabs} options={{ headerShown: false }} />
        ) : (
          <>
            ...
            <Stack.Screen name="Register" options={{ headerShown: false }}>
              {(props) => <RegisterScreen {...props} onRegister={(u) => setUser(u)} />}
            </Stack.Screen>
          </>
        )}
        <Stack.Screen name="PlanDetalle" component={PlanDetailScreen} options={{ title: 'Plan' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
