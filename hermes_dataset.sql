...
-- Opcional: asegurarnos de no tener datos previos
SET FOREIGN_KEY_CHECKS = 0;
TRUNCATE TABLE trip_activities;
TRUNCATE TABLE trip_days;
...
-- ============================
-- Nota: is_recommended = 1 para lugares especialmente recomendados
